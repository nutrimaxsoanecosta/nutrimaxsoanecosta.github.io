...
const resources = [
  ...
  { label: 'Categoria/Pergunta', path: '/admin/categoria-pergunta', description: 'Associe categorias às perguntas.', icon: FiGrid },
  { label: 'Perfil/Pergunta', path: '/admin/perfil-pergunta', description: 'Defina quais perguntas pertencem ao perfil.', icon: FiShield },
